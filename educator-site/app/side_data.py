...
If any information you have provided or uploaded on the Platform violates the Platform Terms, edline may be required to delete such information upon informing you of the same and revoke your access to the Platform if required.
...
edline owns and/or manages several platforms (other than the Platform) that offer a range of services including services related to technology solutions in the space of education, either by itself or through its affiliates and subsidiaries (“edline Group Platforms”). Each of the edline Group Platforms have published their own privacy policies. Accordingly, this Policy does not apply to information collected through the edline Group Platforms and only applies to the collection of your information through the Platform. Please visit the relevant edline Group Platform to know the privacy practices undertaken by them.
...
<br><br><br>
    ...
    <br>
You may be allowed to access and view the Platform as a guest and without creating an account on the Platform or providing any Personal Information; edline does not validate or takes no responsibility towards information, if any, provided by you as a guest, except as otherwise required under any law, regulation, or an order of competent authority. However, to have access to all the features and benefits on our Platform, you are required to first create an account on our Platform. To create an account, you are required to provide certain Personal Information as may be required during the time of registration and all other information requested on the registration page, including the ability to receive promotional offers from edline, is optional. edline may, in future, include other optional requests for information from you to help edline to customize the Platform to deliver personalized information to you. edline may keep records of telephone calls or emails received from or made by you for making enquiries, feedback, or other purposes for the purpose of rendering Services effectively and efficiently.
...
While some of our Services may require collection of a Child’s Personal Information, we do not knowingly collect such Personal Information from a Child and assume that information has been provided with consent of the Parent. If you are a Parent and you are aware that your Child has provided us with any Personal Information without your consent, please contact us at privacy.edline@gmail.com. If we become aware that we have collected Personal Information from a Child in the absence of consent of the Parent, we will take steps to remove such information from our servers.


The information in the relevant parts of this notice applies to Children as well as adults. If your Child faces any form of abuse or harassment while availing our Services, you must write to us atlegal.edline@gmail.com, so that necessary actions could be considered.
...
Third-party platforms to facilitate the additional offerings: We may share information about you with third-party platforms that are used to create interactive forums between Content Providers and Learners to enable the Learners a more conducive environment to extend their learning. The information shared with these platforms are limited to the information required to facilitate your participation in the forums and is based on your consent. However, the privacy practices of these platforms are independent of this Policy, and we suggest that you read through the privacy policies and terms and condition of the platforms relevant to you prior to consenting to being a part of any forums made available on these third-party platforms.
...
protect and defend edline’s or a third party's rights and property, or the safety of edline, our users, our employees, or others; or
prevent, detect, investigate and take measures against criminal activity, fraud and misuse or unauthorized use of our Platform and/or to enforce our Terms and Conditions or other agreements or policies.
...
Business transfers:In the event edline undergoes any merger, acquisition, or sale of company assets, in part or in full, with another company, or in the unlikely event that edline goes out of business or enters bankruptcy, user information would likely be one of the assets that is transferred or acquired by a third party. If any of these events were to happen, this Privacy Policy would continue to apply to your information and the party receiving your information may continue to use your information, but only consistent with this Privacy Policy.
...
All KYC information collected in accordance with this Policy are fully encrypted and cannot be accessed by any person other than the designated authority in edline.
...
<br><br><br>
    ...
    <br>
On unaffiliated sites, edline may display interest-based advertising using information you make available to us when you interact with our Platform and Services. Interest-based ads, also sometimes referred to as personalised or targeted ads, are displayed to you based on information from activities such as registering with our Platform, visiting sites that contain edline content or ads. In providing interest-based ads, we follow applicable laws, as well as the Code for Self-Regulation in Advertising by the Advertising Standards Council of India and the Self-Regulatory Principles for Online Behavioural Advertising developed by the Digital Advertising Alliance (a coalition of marketing, online advertising, and consumer advocacy organizations) and other rules and guidelines issued by the Federal Trade Commission in respect of digital advertising.
...
Right to make a complaint to a government supervisory authority: If you believe we have not processed your Personal Information in accordance with applicable provisions of the GDPR, we encourage you to contact us at privacy.edline@gmail.com. You also have the right to make a GDPR complaint to the relevant Supervisory Authority or seek a remedy through the courts. A list of Supervisory Authorities is available at:https://edpb.europa.eu/about-edpb/board/members_en. If you need further assistance regarding your rights, please contact us using the contact information provided below, and we will consider your request in accordance with applicable law. You can identify the supervising authority of your concern by visitinghttps://edpb.europa.eu/about-edpb/board/members_en.
...
Submission of Instructions: You may submit a request to know or to delete by email to privacy.edline@gmail.com or by submitting a request via mail to edline Inc., Vistra (Delaware) Ltd, 3500 South Dupont Hwy, Dover, Kent, DE 19901. Regarding requests to delete, we may present you with the choice to delete select portions of your Personal Information, but a global option to delete all Personal Information will be offered and more prominently presented.
...
Further, edline may offer certain products/services to you in collaboration with one or more of the edline Group Platforms ( as defined under the Privacy Policy). In such cases, to the extent that such product/services are made available to you through the Platform, the Platform Terms shall continue to apply to you.


For the purpose of the Platform Terms, usage of the terms “Platform Services”/ “Services” shall mean and include all the services referred to in this section and such other products or services as may be offered by edline.


You agree and acknowledge that edline has no control over and assumes no responsibility for, the User-generated Content ( as defined under the ‘Intellectual Property’ section below) and by using the Platform, you expressly relieve edline from any and all liability arising from the User-generated Content.


You agree and acknowledge that edline shall have the right at any time to change or discontinue any Service, product, aspect, or feature of the Platform, including without limitation to, the User-generated Content (to the extent it is permitted to, or required, by virtue of being an ‘intermediary’), its availability and Supported/Compatible device required to access or use the Services. edline reserves the right to terminate your Subscription and / or restrict your access to the Platform, if you choose not to provide / partially provide the requested information.
...
To register on the edline Platform you must meet the ‘Age Requirements’ specified hereinbelow. By using the edline Platform, you, through your actions, affirm that the Age Requirements are met.
...
If you are a resident of India or any other country (except USA, UK or EU countries), then you must have attained at least 18 (eighteen) years of age to register and use the edline Platform;


If you are a resident of the European Union (EU) country and have attained at least 16 (sixteen) years of age, then you are permitted to register and use the edline Platform; and


If you are a resident of the United States of America (USA) or United Kingdom (UK) and have attained at least 13 (thirteen) years of age, then you can register and use the edline Platform.


If you are a resident of the US, UK or EU countries and are between the ages 13 and 18/ 16 and 18 respectively or if you are resident of any other country and are considered to be of any age determined for use of internet services but are less than the contractual age determined by the applicable laws of such country, then by using the Platform, you confirm to us that your use of the Platform is with the permission of your Parent(s) (as defined below), and your Parent has read, agreed and accepted to the Agreement; and in the event of any dispute between you and edline pursuant to your Agreement with us, the terms of our Agreement shall be applicable to and enforceable against your Parent.
...
edline reserves the right to terminate your Subscription and / or restrict your access to the Platform, if it is discovered that you do not meet the Age Requirements and/or the consent to register and use the Platform is not obtained as above. You acknowledge that edline does not have the responsibility to ensure that You conform to the aforesaid Age Requirements. It shall be Your sole responsibility to ensure that the required qualifications are met.


If you are a Content Provider, your access and use of the Platform may additionally be subject to separate agreement(s) with edline and shall be collectively governed by the terms of such agreement, the Terms and Conditions, other Platform Terms, and such other terms as may be communicated or agreed with the Content Provider from time to time.


Further, the permission given by edline to access and use the Platform under these Terms and Conditions is subject to the following conditions:

You agree not to distribute in any medium any part of the Platform, Content Provider Content or the edline Content (as defined below) without edline’s prior written authorization.
...
You agree not to use the Platform for any of the following commercial uses unless you obtain edline’s prior written approval:
...
You agree to receive installs and updates from time to time from edline. These updates are designed to improve, enhance, and further develop the Platform and may take the form of bug fixes, enhanced functions, new software modules and completely new versions. You agree to receive such updates (and permit edline to deliver these to you) as part of your use of the Platform.

You agree not to use or launch any automated system, including without limitation, “robots,” “spiders,” or “offline readers,” that accesses the Platform in a manner that sends more request messages to edline’s servers in a given period of time than a human can reasonably produce in the same period by using a conventional on-line web browser. Notwithstanding the foregoing, edline grants the operators of public search engines permission to use spiders to copy materials from the Site for the sole purpose of and solely to the extent necessary for creating publicly available searchable indices of the materials, but not caches or archives of such materials. edline reserves the right to revoke these exceptions either generally or in specific cases at any time with or without providing any notice in this regard. You agree not to collect or harvest any personally identifiable information, including account names, from the Platform, nor to use the communication systems provided by the Platform, unless otherwise mentioned herein.
...
edline reserves the right to discontinue any aspect of the Platform at any time with or without notice at its sole discretion.
...
The entity within the edline group to which your payments will be made will be on the basis of Annexure 1.

Your payments to edline shall be subject to applicable taxes including without limitation Goods and Service Taxes (GST) and Value Added Taxes (VAT) or other similar taxes as may be applicable in your country of residence/from where you have created your account on the Platform/ purchased the underlying Subscriptions.
...
When you cancel your Subscription, edline may disable access to features made available to you upon your purchase of Subscription, while your account may continue to exist on the Platform.
...
<br><br><br>
    ...
    <br>
Subject to the Platform Terms, edline hereby grants you a non- exclusive, non-transferable, non-sublicensable, limited license to access and use the edline Platform for your own personal, non-commercial and private use on an ‘as is’ basis in accordance with these Terms and Conditions and other Platform Terms.


Subject to payment of the Subscription fee, and your compliance (as a Learner) with all Platform Terms, edline and the Content Providers grant you (as a Learner) a non- exclusive, non-transferable, non-sublicensable, limited license, during the applicable Subscription Period, to access and view the content you have subscribed to and attend live videos in association with your Subscription, for personal, non-commercial, private use only, in accordance with the Platform Terms. We may automatically remove your access to the content from your Compatible Device after the end of the Subscription Period or in accordance with any restriction mentioned in the Platform Terms.


If you are a Content Provider, edline grants you a limited, non-exclusive, non- transferable, non-sublicensable license to access and use the Platform for Your own personal and commercial use in accordance with these Platform Terms and any other agreement(s) that may be executed between you (as a Content Provider) and edline (as applicable). Except as expressly permitted by edline under these Platform Terms or otherwise in writing to you, You will not reproduce, duplicate, copy, sell, redistribute, create derivative works or otherwise exploit the Platform or any portion of the Platform (including but not limited to any copyrighted material, trademarks, or other proprietary information).
...
<br><br><br>
    ...
    <br>
As a User, you may submit User-generated Content ( as defined under the ‘Intellectual Property’ section below) on the Platform. However, you must understand that edline does not guarantee any confidentiality with respect to any User-generated Content you submit.

You shall be solely responsible for your own User-generated Content and the consequences of submitting and publishing such content on the Platform. You affirm, represent, and warrant that you own or have the necessary licenses, rights, consents, and permissions to publish the User-generated Content that you submit. You further agree that User-generated Content you submit on the edline Platform will not contain third party copyrighted material, or material that is subject to other third-party proprietary rights, unless you have permission from the rightful owner of the material, or you are otherwise legally entitled to post the material and to grant edline the necessary license and rights required under the Platform Terms. You shall solely be responsible for all claims in respect of your User-generated Content published on the Platform.

For clarity, you retain your ownership rights in your User-generated Content. However, you grant a limited license to edline to make available the User-generated Content on the Platform. Please read the ‘Intellectual Property’ section below to know the exact nature of license and rights you grant to edline.
...
is defamatory, obscene, pornographic, invasive of another’s privacy including bodily privacy, insulting or harassing on the basis of gender, libelous, racially or ethnically objectionable, relating or encouraging money laundering or gambling, or otherwise inconsistent with or contrary to the laws in force;
...
You understand that as a User you may interact with Minors/Children (refer to ‘Right to Access and Account Creation’ section above) on the Platform; accordingly, you shall make yourself fully aware of our Minor & Learner Interaction Guidelines and conduct yourself in accordance thereof.

You understand and confirm that you shall not during your use of the edline Platform at any time post or publish any content, comments or act in any way which will amount to harassment of any other User. If at any given point it comes to edline’s notice that you have engaged in any kind of harassment of other Users, then in such a case you agree that edline shall have the sole right to suspend/terminate your account with immediate effect and without any notice of such suspension or termination and we also reserve the right in our sole discretion to initiate any legal proceedings against you in such cases.

edline does not endorse any User-generated Content submitted on the edline Platform by any User, or any opinion, recommendation, or advice expressed therein, and edline expressly disclaims any and all liability in connection with User-generated Content. edline does not permit copyright infringing activities and infringement of intellectual property rights on the edline Platform, and edline will remove all User-generated Content if properly notified that such User-generated Content infringes on another’s intellectual property rights in line with its obligations as an ‘intermediary’. edline reserves the right to remove User- generated Content without prior notice if it has reason to believe that the User- generated Content is violative of these Terms and Conditions. Please refer to the Takedown Policy and ‘Copyright, Trademarks and other Intellectual Property Rights’section below to understand the process to notify edline about any infringing content and the process of takedown of infringing content followed by edline.
...
You shall not engage in any activity that will negatively impact edline and/or other Users of the Platform, including without limitation, activities that involve screen- recording, screen-casting or downloading on any other device of any Content Provider Content (live or recorded) in any manner that is not directly facilitated as feature within the Platform and/or sharing or otherwise publishing such screen-recorded content on third-party platforms, either for a cost or otherwise. If edline becomes aware of your engagement, either by yourself or through a third-party, in any such activity, then edline may immediately terminate your or such User’s access / Subscription along with termination and removal of access to all downloaded content with a right to initiate appropriate legal action, at the sole discretion of edline.
...
<br><br><br>
    ...
    <br>
When you visit the Platform, you are communicating with us electronically. You may be required to provide a valid phone number while creating any account with us or while enrolling or purchasing any Subscription Service. We may communicate with you by e- mail, SMS, phone call, WhatsApp or by posting notices on the Platform or by any other mode of communication. By providing your information you authorize edline, its affiliates, and their respective employees, agents, and contractors to initiate electronic communications by email, telephone calls, WhatsApp or such other mode of communication with respect to your use of the Platform and regarding the products and services offered by edline and its affiliates. These communications may be made by or on behalf of edline, even if your phone number is registered on any state or federal do not call list. Telephone calls may be recorded. You acknowledge that your telephone operator and/or internet service provider may have levied certain charges on you vis-à-vis your communications with edline as it constitutes availing their services, and you agree to be responsible for all such charges, and edline will not be responsible for any such charges. Do not submit your information if you do not consent to being contacted by telephone, text, email, WhatsApp or such other mode of communication. Further, you will always have an option to unsubscribe / opt out from any promotional communications sent by edline and / or its affiliates either by following the relevant instructions that may be communicated via text, email or such other mode of communication in which you received a promotional communication or by disabling the options provided within your account on the Platform.
...
Further, in respect of interactions between Users - edline is only an intermediary and does not monitor any of the interactions that take place between Users on the Platform, but edline has clearly laid out the terms and guidelines a User must follow in their conduct on the Platform as part of the Platform Terms; and if edline receives from any User a complaint of misconduct against you, in any form, or if edline otherwise deems necessary, edline reserves the right to suspend or terminate your access to any the Platform or any part thereof at any time, with or without giving any notice or reason.
...
edline Content: edline and / or its affiliates own all information and materials (in whatever form or media) provided or communicated to you by or on behalf of edline including but not limited to, the Platform, illustrations, letters, images, ideas, concepts, the layout, design, flow, look and feel of the Platform, logos, marks, graphics, audio files, video files, any software which is owned by or licensed to edline and / or its affiliates, the underlying source and object code, instructions embedded in any form of digital documents and other data, information, or material made available to you by edline (“edline Content”). edline Content specifically excludes any content uploaded by the Users, including without limitation, any User-generated Content on the Platform. edline Content, including its trademarks, will not be used, modified, or altered by you in any way. You acknowledge and agree that you do not acquire any ownership or rights to the edline Content or the Platform by use of the Platform. You acknowledge and agree that the edline Content is protected by the copyright, trademark, patent, trade secret and other intellectual property or proprietary rights laws and any unauthorize use, reproduction, modification, distribution, transmission, republication, display or performance of the edline Content and any component thereof is strictly prohibited.


You confirm and undertake not to utilize any data mining tools, robots, or similar data gathering and extraction tools to extract for re-utilization of any substantial parts of this Platform, without edline’s express prior written consent.
...
<br><br><br>
    ...
    <br>
If any User(s) submits suggestions, ideas, comments, or questions containing product feedback about the Platform or any of the Services, either through the Platform or otherwise (“Feedback”), then such User(s) grants edline and its affiliates a worldwide, non-exclusive, royalty-free, perpetual, and irrevocable right to use (and full right to sublicense), reproduce, modify, adapt, publish, translate, create derivative works from, distribute, transmit, and display such Feedback in any form. Users shall have no intellectual property right in the Platform as a result of edline’s incorporation of their Feedback in the Platform.
...
<br><br><br>
    ...
    <br>
At edline, we respect the intellectual property of others just as much ours and, hence, if you believe that your intellectual property rights have been used in a way that gives rise to concerns of infringement of your intellectual property (including your copyrights and trademarks), then kindly write to us at legal.edline@gmail.com with complete details as required under Takedown Policy. If edline has knowledge of or has any reason to believe that any User-generated Content on the Platform violates the intellectual property rights of edline or other Users, then we reserve the right to remove access to such content in accordance with takedown practices specified in Takedown Policy.

If edline has knowledge of or has any reason to believe that any User-generated Content on the Platform violates the intellectual property rights of edline or other Users, then we reserve the right to remove access to such content in accordance with takedown practices specified in Takedown Policy.
...
<br><br><br>
    ...
    <br>
edline does not monitor or have any control over or does not warrant, and makes no claim or representation regarding the accuracy, completeness, or usefulness of any User-generated Content provided on the Platform by its Users and accepts no responsibility for reviewing changes or updates to, or the quality, content, policies, nature or reliability of, such User-generated Content. edline disclaims all liability and responsibility arising from any reliance placed on such materials by you. All statements and/or opinions expressed in these materials, and all articles and responses to questions and other content, other than the edline Content, are solely the responsibility of the User providing those materials.
...
<br><br><br>
    ...
    <br>
In respect of the entire Platform, edline reserves the following rights:


edline reserves the right to put on-hold or reject or suspend or terminate your registration on the Platform for the purpose of complying with the legal and regulatory requirements.

edline reserves the right to remove you and/or the User-generated Content without notice if you violate any provisions of the Platform Terms.

edline may modify, terminate, or refuse to provide Services at any time for any reason, without notice.

Notwithstanding anything contrary stated in the Platform Terms, in its sole discretion, edline may remove anyone from the Platform at any time for any reason.

edline reserves the right to access your account and/or the User-generated Content in order to respond to requests for technical support, to maintain the safety and security of the Platform, legal purposes and for other legitimate business purposes, as necessary, in edline’s discretion.

edline has no obligation to monitor any content that appears on the Platform or review any conduct occurring through the Platform, including any interactions between Users, however, if edline receives notice or becomes aware of, any violation of the Platform Terms, then, edline reserves the right to refuse your access to the Platform, terminate accounts or remove such violating content at any time without notice to you.
...
<br><br><br>
    ...
    <br>
Your access to the Platform may occasionally be suspended or restricted to allow for repairs, maintenance, or due to the introduction of new facilities or services at any time without prior notice. We will attempt to limit the frequency and duration of any such suspension or restriction. You agree that edline will not be liable for any losses that may be incurred by you if for any reason all or part of the Platform is unavailable at any time or for any period for use.
...
If you are a Content Provider, your access and use of the Platform may be subject to a separate agreement with edline and shall be collectively governed by the terms of such agreement, the Terms and Conditions and other Platform Terms.
...
<br><br><br>
    ...
    <br>
TO THE FULLEST EXTENT PERMITTED BY LAW, IN NO EVENT SHALL edline, ITS AFFILIATES, THEIR RESPECTIVE OFFICERS, DIRECTORS, EMPLOYEES, OR AGENTS, BE LIABLE TO YOU FOR ANY DIRECT, INDIRECT, INCIDENTAL, SPECIAL, PUNITIVE, LOSSES OR EXPENSES OR CONSEQUENTIAL DAMAGES WHATSOEVER RESULTING FROM ANY (I) ERRORS, MISTAKES, OR INACCURACIES OF USER-GENERATED CONTENT OR ANY OTHER CONTENT AVAILABLE AT edline, (II) PERSONAL INJURY OR PROPERTY DAMAGE, OF ANY NATURE WHATSOEVER, RESULTING FROM YOUR ACCESS TO AND USE OF OUR edline PLATFORMS, (III) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS AND/OR ANY AND ALL PERSONAL INFORMATION AND/OR FINANCIAL INFORMATION STORED THEREIN, (IV) ANY INTERRUPTION OR CESSATION OF TRANSMISSION TO OR FROM THE edline PLATFORM, (IV) ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE, WHICH MAY BE TRANSMITTED TO OR THROUGH OUR edline PLATFORMS BY ANY THIRD PARTY, AND/OR (V) ANY ERRORS OR OMISSIONS IN ANY USER-GENERATED CONTENT OR ANY OTHER CONTENT OR FOR ANY LOSS OR DAMAGE OF ANY KIND INCURRED AS A RESULT OF YOUR USE OF ANY CONTENT POSTED, EMAILED, TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA THE edline PLATFORM, WHETHER BASED ON WARRANTY, CONTRACT, TORT, OR ANY OTHER LEGAL THEORY, AND WHETHER OR NOT edline IS ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.


WE UNDERSTAND THAT, IN SOME JURISDICTIONS, WARRANTIES, DISCLAIMERS AND CONDITIONS MAY APPLY THAT CANNOT BE LEGALLY EXCLUDED, IF THAT IS TRUE IN YOUR JURISDICTION, THEN TO THE EXTENT PERMITTED BY LAW, edline AND ITS AFFILIATES LIMIT THEIR LIABILITY FOR ANY CLAIMS UNDER THOSE WARRANTIES OR CONDITIONS TO SUPPLYING YOU THE edline PLATFORM AGAIN.


YOU SPECIFICALLY ACKNOWLEDGE THAT edline SHALL NOT BE LIABLE FOR USER- GENERATED CONTENT OR THE DEFAMATORY, OFFENSIVE, OR ILLEGAL CONDUCT OF ANY THIRD PARTY AND THAT THE RISK OF HARM OR DAMAGE FROM THE FOREGOING RESTS ENTIRELY WITH YOU.


THE edline PLATFORM IS CONTROLLED AND OFFERED BY edline AND / OR ITS AFFILIATES DEPENDING UPON YOUR JURISDICTION. edline MAKES NO REPRESENTATIONS THAT THE edline PLATFORM IS APPROPRIATE OR AVAILABLE FOR USE IN OTHER LOCATIONS. THOSE WHO ACCESS OR USE THE edline PLATFORM FROM OTHER JURISDICTIONS DO SO AT THEIR OWN VOLITION AND ARE RESPONSIBLE FOR COMPLIANCE WITH LOCAL LAW.
...
<br><br><br>
    ...
    <br>
For queries relating to Services offered by edline, please write to us at help.edline@gmail.com.
...
Name: Siddharth Manchanda (Legal Department)

Contact:legal.edline@gmail.com


Grievance Officer Details –
Name: Abhyudaya Rana

Contact:consumergrievance.edline@gmail.com
...
<br><br><br>
    ...
    <br>
If you have concerns or queries regarding the Platform Terms, you may write to us by email atlegal.edline@gmail.com or by post to:
